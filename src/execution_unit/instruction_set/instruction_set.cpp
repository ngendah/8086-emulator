...
InstructionSet::InstructionSet() {
  ...
  _instruction_code_map.insert(
      {0x00, InstructionCode(0x00, "ADD", "Eb", "Gb")});
  _instruction_code_map.insert(
      {0x01, InstructionCode(0x01, "ADD", "Ew", "Gw")});
  _instruction_code_map.insert(
      {0x02, InstructionCode(0x02, "ADD", "Gb", "Eb")});
  _instruction_code_map.insert(
      {0x03, InstructionCode(0x03, "ADD", "Gw", "Ew")});
  ...
  _instruction_code_map.insert(
      {0x10, InstructionCode(0x10, "ADC", "Eb", "Gb")});
  _instruction_code_map.insert(
      {0x11, InstructionCode(0x11, "ADC", "Ew", "Gw")});
  _instruction_code_map.insert(
      {0x12, InstructionCode(0x12, "ADC", "Gb", "Eb")});
  _instruction_code_map.insert(
      {0x13, InstructionCode(0x13, "ADC", "Gw", "Ew")});
  ...
  _instruction_code_map.insert(
      {0x18, InstructionCode(0x18, "SBB", "Eb", "Gb")});
  _instruction_code_map.insert(
      {0x19, InstructionCode(0x19, "SBB", "Ew", "Gw")});
  _instruction_code_map.insert(
      {0x1A, InstructionCode(0x1A, "SBB", "Gb", "Eb")});
  _instruction_code_map.insert(
      {0x1B, InstructionCode(0x1B, "SBB", "Gw", "Ew")});
  ...
  _instruction_code_map.insert(
      {0x20, InstructionCode(0x20, "AND", "Eb", "Gb")});
  _instruction_code_map.insert(
      {0x21, InstructionCode(0x21, "AND", "Ew", "Gw")});
  _instruction_code_map.insert(
      {0x22, InstructionCode(0x22, "AND", "Gb", "Eb")});
  _instruction_code_map.insert(
      {0x23, InstructionCode(0x23, "AND", "Gw", "Ew")});
  ...
  _instruction_code_map.insert(
      {0x28, InstructionCode(0x28, "SUB", "Eb", "Gb")});
  _instruction_code_map.insert(
      {0x29, InstructionCode(0x29, "SUB", "Ew", "Gw")});
  _instruction_code_map.insert(
      {0x2A, InstructionCode(0x2A, "SUB", "Gb", "Eb")});
  _instruction_code_map.insert(
      {0x2B, InstructionCode(0x2B, "SUB", "Gw", "Ew")});
  ...
  _instruction_code_map.insert(
      {0x30, InstructionCode(0x30, "XOR", "Eb", "Gb")});
  _instruction_code_map.insert(
      {0x31, InstructionCode(0x31, "XOR", "Ew", "Gw")});
  _instruction_code_map.insert(
      {0x32, InstructionCode(0x32, "XOR", "Gb", "Eb")});
  _instruction_code_map.insert(
      {0x33, InstructionCode(0x33, "XOR", "Gw", "Ew")});
  ...
  _instruction_code_map.insert(
      {0x38, InstructionCode(0x38, "CMP", "Eb", "Gb")});
  _instruction_code_map.insert(
      {0x39, InstructionCode(0x39, "CMP", "Ew", "Gw")});
  _instruction_code_map.insert(
      {0x3A, InstructionCode(0x3A, "CMP", "Gb", "Eb")});
  _instruction_code_map.insert(
      {0x3B, InstructionCode(0x3B, "CMP", "Gw", "Ew")});
  ...
  _instruction_code_map.insert(
      {0x80, InstructionCode(0x80, "GRP1", "Eb", "Ib")});
  _instruction_code_map.insert(
      {0x81, InstructionCode(0x81, "GRP1", "Ew", "Iw")});
  _instruction_code_map.insert(
      {0x82, InstructionCode(0x82, "GRP1", "Eb", "Ib")});
  _instruction_code_map.insert(
      {0x83, InstructionCode(0x83, "GRP1", "Ew", "Ib")});
  _instruction_code_map.insert(
      {0x84, InstructionCode(0x84, "TEST", "Gb", "Eb")});
  _instruction_code_map.insert(
      {0x85, InstructionCode(0x85, "TEST", "Gw", "Ew")});
  _instruction_code_map.insert(
      {0x86, InstructionCode(0x86, "XCHG", "Gb", "Eb")});
  _instruction_code_map.insert(
      {0x87, InstructionCode(0x87, "XCHG", "Gw", "Ew")});
  _instruction_code_map.insert(
      {0x88, InstructionCode(0x88, "MOw", "Eb", "Gb")});
  _instruction_code_map.insert(
      {0x89, InstructionCode(0x89, "MOw", "Ew", "Gw")});
  _instruction_code_map.insert(
      {0x8A, InstructionCode(0x8A, "MOw", "Gb", "Eb")});
  _instruction_code_map.insert(
      {0x8B, InstructionCode(0x8B, "MOw", "Gw", "Ew")});
  _instruction_code_map.insert(
      {0x8C, InstructionCode(0x8C, "MOw", "Ew", "Sw")});
  _instruction_code_map.insert({0x8D, InstructionCode(0x8D, "LEA", "Gw", "M")});
  _instruction_code_map.insert(
      {0x8E, InstructionCode(0x8E, "MOw", "Sw", "Ew")});
  ...
  _instruction_code_map.insert(
      {0xA8, InstructionCode(0xA8, "TEST", "b", "Ib")});
  _instruction_code_map.insert(
      {0xA9, InstructionCode(0xA9, "TEST", "w", "Iw")});
  ...
  _instruction_code_map.insert(
      {0xB4, InstructionCode(0xB4, "MOw", "AH", "Ib")});
  _instruction_code_map.insert(
      {0xB5, InstructionCode(0xB5, "MOw", "CH", "Ib")});
  _instruction_code_map.insert(
      {0xB6, InstructionCode(0xB6, "MOw", "DH", "Ib")});
  _instruction_code_map.insert(
      {0xB7, InstructionCode(0xB7, "MOw", "BH", "Ib")});
  ...
  _instruction_code_map.insert(
      {0xC4, InstructionCode(0xC4, "LES", "Gw", "Mp")});
  _instruction_code_map.insert(
      {0xC5, InstructionCode(0xC5, "LDS", "Gw", "Mp")});
  _instruction_code_map.insert(
      {0xC6, InstructionCode(0xC6, "MOw", "Eb", "Ib")});
  _instruction_code_map.insert(
      {0xC7, InstructionCode(0xC7, "MOw", "Ew", "Iw")});
  ...
  _instruction_code_map.insert(
      {0xD0, InstructionCode(0xD0, "GRP2", "Eb", "1")});
  _instruction_code_map.insert(
      {0xD1, InstructionCode(0xD1, "GRP2", "Ew", "1")});
  _instruction_code_map.insert(
      {0xD2, InstructionCode(0xD2, "GRP2", "Eb", "b")});
  _instruction_code_map.insert(
      {0xD3, InstructionCode(0xD3, "GRP2", "Ew", "b")});
