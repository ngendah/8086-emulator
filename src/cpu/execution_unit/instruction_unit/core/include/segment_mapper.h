...
public:
  ...
  static const uint8_t SOP_CS_INDEX = cast_ui8(1 << 3);
  static const uint8_t SOP_SS_INDEX = cast_ui8(2 << 3);
  static const uint8_t SOP_DS_INDEX = cast_ui8(3 << 3);
};
